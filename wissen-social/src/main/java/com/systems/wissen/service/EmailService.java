...
public class EmailService {
	...
	private MimeMessage createMessage(Employee employeeById, Session defaultInstance) throws MessagingException {
		...
		message.setText(
				"Thank you for your interest in WiseConnect. After reviewing your application ,we have decided to reject your application\r"
